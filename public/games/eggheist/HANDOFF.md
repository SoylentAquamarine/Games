...
- **2 more games from the same comment**: both "half text half graphics"
  games in the style of Oregon Trail (status/stat display alongside
  simple graphics, choice-driven events). Not started — see the root
