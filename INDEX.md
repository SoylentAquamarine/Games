...
A chicken-themed browser-games arcade (95 games), deployed on **Cloudflare Workers**. Live at **https://games.square-bar-75ce.workers.dev**. This file is a map of the repo for quick navigation (e.g. by an AI reading the GitHub).
...
| [`public/games/INDEX.md`](public/games/INDEX.md) | **Full games listing** — slug → name → description table (95 games). |
